                ...
                <div class="card indigo form-white">
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <input maxlength="100" type="search" id="pregunta" name="pregunta" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"required autocomplete="off">  
                        </div>
                        <br><br>
